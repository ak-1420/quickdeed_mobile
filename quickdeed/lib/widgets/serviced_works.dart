...
class ServicedWorks extends StatelessWidget {
  ServicedWorks({Key? key}) : super(key: key);

  final List<UserWorksModel> works = [
    UserWorksModel(
        userName: "Arun" , workName: "Coding" , amount: 100.0 ,
        workType: "Education" , isPosted: false , workStatus: "completed"
    ),
    UserWorksModel(
        userName: "Kranthi" , workName: "Maths Teaching" , amount: 500.0 ,
        workType: "Education" , isPosted: false , workStatus: "in progess"
    ),
    UserWorksModel(
        userName: "Hema" , workName: "Anchor" , amount: 1000.0 ,
        workType: "Entertainment" , isPosted: false , workStatus: "in progess"
    ),
    UserWorksModel(
        userName: "Gayathri" , workName: "Training" , amount: 1500.0 ,
        workType: "Sports" , isPosted: false , workStatus: "completed"
    ),
    UserWorksModel(
        userName: "Roseli" , workName: "mentoring" , amount: 2500.0 ,
        workType: "open source" , isPosted: false ,  workStatus: "in progess"
    ),
    UserWorksModel(
        userName: "Arun" , workName: "Coding" , amount: 100.0 ,
        workType: "Education" , isPosted: false , workStatus: "completed"
  ...
  Widget build(BuildContext context) {
    ...
    if(works.isEmpty) return Center(child:  Text("You haven't serviced any works yet "));
